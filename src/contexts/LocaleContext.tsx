...
const translations = {
  en: {
    ...
    'nav.customer': 'Manage your profile information',
    ...
    'address.street.placeholder': 'e.g. Av. Insurgentes Sur 123, Int. 4B',
    'address.neighborhood': 'Neighborhood',
    'address.neighborhood.placeholder': 'e.g. Roma Norte',
    'address.borough': 'Borough',
    'address.borough.placeholder': 'Select Borough',
    'address.city': 'City',
    'address.state': 'State', 
    'address.postal-code': 'Postal Code',
    'address.postal-code.placeholder': '06700',
    'address.default-service': 'Default Service Address',
    'address.default-service.note': 'This will be your default address for service bookings. You can change it for individual bookings.',
    // Settings page translations
    'settings.welcome': 'Welcome',
    'settings.profile-info': 'Profile Information',
    'settings.account-actions': 'Account Actions',
    'settings.language-preference': 'Language Preference',
    'settings.change-language': 'Interface Language',
    ...
    'settings.phone.note': 'Used for booking confirmations and communication with professionals',
    'settings.email': 'Email Address',
    'settings.email.note': 'Email cannot be changed. Contact support if you need to update your email.',
    'settings.change-password': 'Change Password',
    'settings.change-password.desc': 'Update your account password',
    'settings.email-notifications': 'Email Notifications',
    'settings.email-notifications.desc': 'Manage your notification preferences',
    'settings.delete-account': 'Delete Account',
    'settings.delete-account.desc': 'Permanently delete your account and data',
    'settings.change': 'Change',
    'settings.manage': 'Manage',
    'settings.delete': 'Delete',
    'settings.cancel': 'Cancel',
    // Change Password Modal
    'settings.modal.change-password': 'Change Password',
    'settings.modal.current-password': 'Current Password',
    'settings.modal.new-password': 'New Password',
    'settings.modal.confirm-new-password': 'Confirm New Password',
    'settings.modal.password-requirements': 'Password must be at least 6 characters long',
    'settings.modal.password-changed': 'Password changed successfully!',
    'settings.modal.passwords-dont-match': 'Passwords do not match',
    // Delete Account Modal
    'settings.modal.delete-account': 'Delete Account',
    'settings.modal.delete-warning': 'This action cannot be undone. This will permanently delete your account and all associated data.',
    'settings.modal.delete-confirmation': 'Type "DELETE MY ACCOUNT" to confirm',
    'settings.modal.delete-password': 'Enter your password to confirm',
    'settings.modal.account-deleted': 'Account deleted successfully',
    'settings.modal.close': 'Close',
    'settings.modal.confirm': 'Confirm',
    // Password visibility
  ...
  es: {
    ...
    'nav.dashboard': 'Panel',
    'nav.customer': 'Administra tu información de perfil',
    ...
    'address.street.placeholder': 'ej. Av. Insurgentes Sur 123, Int. 4B',
    'address.neighborhood': 'Colonia',
    'address.neighborhood.placeholder': 'ej. Roma Norte',
    'address.borough': 'Alcaldía',
    'address.borough.placeholder': 'Seleccionar Alcaldía',
    'address.city': 'Ciudad',
    'address.state': 'Estado',
    'address.postal-code': 'Código Postal',
    'address.postal-code.placeholder': '06700',
    'address.default-service': 'Dirección de Servicio Predeterminada',
    'address.default-service.note': 'Esta será tu dirección predeterminada para reservas de servicios. Puedes cambiarla para reservas individuales.',
    // Settings page translations
    'settings.welcome': 'Bienvenido',
    'settings.profile-info': 'Información del Perfil',
    'settings.account-actions': 'Acciones de Cuenta',
    'settings.language-preference': 'Preferencia de Idioma',
    'settings.change-language': 'Idioma de la Interfaz',
    'settings.english': 'English',
    'settings.spanish': 'Español',
    'settings.save-changes': 'Guardar Cambios',
    'settings.saving': 'Guardando...',
    'settings.profile-updated': '¡Perfil actualizado exitosamente!',
    'settings.first-name': 'Nombre',
    'settings.last-name': 'Apellido',
    'settings.phone': 'Número de Teléfono',
    'settings.phone.note': 'Usado para confirmaciones de reservas y comunicación con profesionales',
    'settings.email': 'Correo Electrónico',
    'settings.email.note': 'El correo electrónico no se puede cambiar. Contacta soporte si necesitas actualizar tu correo.',
    'settings.change-password': 'Cambiar Contraseña',
    'settings.change-password.desc': 'Actualiza tu contraseña de cuenta',
    'settings.email-notifications': 'Notificaciones por Email',
    'settings.email-notifications.desc': 'Administra tus preferencias de notificaciones',
    'settings.delete-account': 'Eliminar Cuenta',
    'settings.delete-account.desc': 'Eliminar permanentemente tu cuenta y datos',
    'settings.change': 'Cambiar',
    'settings.manage': 'Administrar',
    'settings.delete': 'Eliminar',
    'settings.cancel': 'Cancelar',
    // Change Password Modal
    'settings.modal.change-password': 'Cambiar Contraseña',
    'settings.modal.current-password': 'Contraseña Actual',
    'settings.modal.new-password': 'Nueva Contraseña',
    'settings.modal.confirm-new-password': 'Confirmar Nueva Contraseña',
    'settings.modal.password-requirements': 'La contraseña debe tener al menos 6 caracteres',
    'settings.modal.password-changed': '¡Contraseña cambiada exitosamente!',
    'settings.modal.passwords-dont-match': 'Las contraseñas no coinciden',
    // Delete Account Modal
    'settings.modal.delete-account': 'Eliminar Cuenta',
    'settings.modal.delete-warning': 'Esta acción no se puede deshacer. Esto eliminará permanentemente tu cuenta y todos los datos asociados.',
    'settings.modal.delete-confirmation': 'Escribe "DELETE MY ACCOUNT" para confirmar',
    'settings.modal.delete-password': 'Ingresa tu contraseña para confirmar',
    'settings.modal.account-deleted': 'Cuenta eliminada exitosamente',
    'settings.modal.close': 'Cerrar',
    'settings.modal.confirm': 'Confirmar',
    // Password visibility
