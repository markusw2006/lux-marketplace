...
// Simple admin dashboard without authentication for testing
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-4 mb-8">
          <Link href="/admin/simple-pro-apps" className="bg-white p-4 rounded-lg shadow hover:shadow-md transition-shadow border border-gray-200">
          ...
          <Link href="/admin/whatsapp-test" className="bg-white p-4 rounded-lg shadow hover:shadow-md transition-shadow border border-gray-200">
            <div className="flex items-center">
              ...
              <span className="text-sm font-medium text-gray-900">WhatsApp Test</span>
            </div>
          </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="text-lg font-medium text-gray-900">$285,640 MXN</dd>
                </dl>
              </div>
            </div>
          </div>
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg p-6">
          <h3 className="text-lg font-semibold text-green-800 mb-2">🎉 Admin Panel Test Mode Active!</h3>
          <p className="text-green-700 mb-4">
            This is a simplified admin dashboard for testing. Available features: <strong>Pro Applications Management</strong> and <strong>WhatsApp Integration Testing</strong>.
          </p>
          <div className="flex space-x-3">
            <Link 
              href="/admin/simple-pro-apps"
              className="inline-flex items-center px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors"
            >
              <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
              </svg>
              Test Pro Applications
            </Link>
            <Link 
