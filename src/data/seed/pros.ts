...
export const professionals: Professional[] = [
  // Cleaning Professionals
  {
    ...
    tagline: 'Residential cleaning specialist - 8+ years',
    bio: 'Professional cleaning service with over 8 years of experience in CDMX. I use eco-friendly products and guarantee 100% satisfaction.',
  ...
  },
  {
    ...
    tagline: 'Fast and efficient cleaning - Available 7 days',
    bio: 'Express cleaning service for busy people. Specialized in apartments and small offices.',
  ...
  },
  {
    ...
    tagline: 'Professional team - 48h guarantee',
    bio: 'Team of 3 people specialized in deep cleaning and residential maintenance. Premium service with guarantee.',
  ...
  // Plumbing Professionals
  {
    ...
    tagline: 'Expert plumber - 15+ years CDMX',
    bio: 'Professional plumber with over 15 years of experience. Specialized in residential repairs and 24/7 emergencies.',
  ...
  },
  {
    ...
    tagline: 'Fast service - 6 months guarantee',
    bio: 'Certified plumber focused on fast and lasting solutions. Specialist in plumbing installations.',
  ...
  // Electrical Professionals  
  {
    ...
    tagline: 'Certified electrician - Safety guaranteed',
    bio: 'Professional electrician certified by CFE. Specialized in residential installations and electrical repairs.',
  ...
  // Handyman Professionals
  {
    ...
    tagline: 'General repair specialist - All in one',
    bio: 'Specialist in general home repairs. TV mounting, furniture assembly, and small repairs.',
